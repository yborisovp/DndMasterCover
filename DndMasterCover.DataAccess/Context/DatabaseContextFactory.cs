...
public class DatabaseContextFactory : IDatabaseContextFactory<DatabaseContext>
{
    ...
    public DatabaseContext CreateDbContext()
    {
        ...
        NpgsqlDbContextOptionsBuilderExtensions.UseNpgsql((DbContextOptionsBuilder)optionsBuilder,
    ...
    public static DatabaseContext CreateDbContext(DbContextOptionsBuilder<DatabaseContext> optionsBuilder,
